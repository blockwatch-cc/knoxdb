...
var cmp_ge [16]cmpFunc = [16]cmpFunc{
	cmp_ge_0, cmp_ge_1, cmp_ge_2, cmp_ge_3, cmp_ge_4, cmp_ge_5, cmp_ge_6, cmp_ge_7,
	cmp_ge_8, cmp_ge_9, cmp_ge_10, cmp_ge_11, cmp_ge_12, cmp_ge_13, cmp_ge_14, cmp_ge_15,
}
...
func cmp_ge_3(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x3)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_4(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x7)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_5(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0xF)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_6(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x1F)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_7(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x3F)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_8(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x7F)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_9(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0xFF)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_10(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x3FF)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_11(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0xFFF)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_12(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0x7FFF)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_13(word, val uint64) (int, uint64) {
	var bits uint64
	mask := uint64(0xFFFFF)
	if val <= mask {
		bits = b2u64(word&mask >= val) |
...
func cmp_ge_14(word, val uint64) (int, uint64) {
	var bits uint64
...
func cmp_ge_15(word, val uint64) (int, uint64) {
