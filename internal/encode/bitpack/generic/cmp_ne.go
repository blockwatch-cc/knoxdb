...
var cmp_ne = [...]cmpFunc{
	cmp_bp_0_ne, cmp_bp_1_ne, cmp_bp_2_ne, cmp_bp_3_ne,
	cmp_bp_4_ne, cmp_bp_5_ne, cmp_bp_6_ne, cmp_bp_7_ne,
	cmp_bp_8_ne, cmp_bp_9_ne, cmp_bp_10_ne, cmp_bp_11_ne,
	cmp_bp_12_ne, cmp_bp_13_ne, cmp_bp_14_ne, cmp_bp_15_ne,
	cmp_bp_16_ne, cmp_bp_17_ne, cmp_bp_18_ne, cmp_bp_19_ne,
	cmp_bp_20_ne, cmp_bp_21_ne, cmp_bp_22_ne, cmp_bp_23_ne,
	cmp_bp_24_ne, cmp_bp_25_ne, cmp_bp_26_ne, cmp_bp_27_ne,
	cmp_bp_28_ne, cmp_bp_29_ne, cmp_bp_30_ne, cmp_bp_31_ne,
	cmp_bp_32_ne, cmp_bp_33_ne, cmp_bp_34_ne, cmp_bp_35_ne,
	cmp_bp_36_ne, cmp_bp_37_ne, cmp_bp_38_ne, cmp_bp_39_ne,
	cmp_bp_40_ne, cmp_bp_41_ne, cmp_bp_42_ne, cmp_bp_43_ne,
	cmp_bp_44_ne, cmp_bp_45_ne, cmp_bp_46_ne, cmp_bp_47_ne,
	cmp_bp_48_ne, cmp_bp_49_ne, cmp_bp_50_ne, cmp_bp_51_ne,
	cmp_bp_52_ne, cmp_bp_53_ne, cmp_bp_54_ne, cmp_bp_55_ne,
	cmp_bp_56_ne, cmp_bp_57_ne, cmp_bp_58_ne, cmp_bp_59_ne,
	cmp_bp_60_ne, cmp_bp_61_ne, cmp_bp_62_ne, cmp_bp_63_ne,
}

func cmp_bp_0_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	if val != 0 {
		return bits.One()
	}
	return bits
...
func cmp_bp_1_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
...
func cmp_bp_2_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 2 bit packing
	// [aabb ccdd] [eeff gghh]
	var (
		i    int
...
func cmp_bp_3_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 3 bit packed
...
func cmp_bp_4_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 4bit packed
...
func cmp_bp_5_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 5bit packed
...
func cmp_bp_6_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 6bit packed
...
func cmp_bp_7_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 7bit packed
...
func cmp_bp_10_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 10bit packed
...
func cmp_bp_11_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 11bit packed
...
func cmp_bp_12_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 12bit packed
...
func cmp_bp_13_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 13bit packed
...
func cmp_bp_14_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 14bit packed
...
func cmp_bp_15_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 15bit packed
...
func cmp_bp_16_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 16bit packed
...
func cmp_bp_17_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 17bit packed
...
func cmp_bp_18_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 18bit packed
...
func cmp_bp_19_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 19bit packed
...
func cmp_bp_20_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 20bit packed
...
func cmp_bp_21_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 21bit packed
...
func cmp_bp_22_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 22bit packed
...
func cmp_bp_23_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 23bit packed
...
func cmp_bp_24_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 24bit packed
...
func cmp_bp_25_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 25bit packed
...
func cmp_bp_26_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 26 bit packed
...
func cmp_bp_27_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 27 bit packed
...
func cmp_bp_28_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 28 bit packed
...
func cmp_bp_29_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 29 bit packed
...
func cmp_bp_30_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 30 bit packed
...
func cmp_bp_31_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 31 bit packed
...
func cmp_bp_32_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 32 bit packed
...
func cmp_bp_33_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 33 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_34_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 34 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_35_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 35 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_36_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 36 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_37_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 37 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_38_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 38 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_39_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 39 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_40_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 40 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_41_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 41 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_42_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 42 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_43_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 43 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_44_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 44 bit packed
...
func cmp_bp_45_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 45 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_46_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 46 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_47_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 47 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_48_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 48 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_49_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 49 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_50_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 50 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_51_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 51 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_52_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 52 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_53_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 53 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_54_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 54 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_55_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 55 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_56_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 56 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_57_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 57 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_58_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 58 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_59_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 59 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
...
func cmp_bp_60_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 60 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaabbbb]
	// [bbbbbbbb] [bbbbbbbb] [bbbbbbbb] [bbbbbbbb]
...
func cmp_bp_61_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 61 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaabbb]
	// [bbbbbbbb] [bbbbbbbb] [bbbbbbbb] [bbbbbbbb]
...
func cmp_bp_62_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 62 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaabb]
	// [bbbbbbbb] [bbbbbbbb] [bbbbbbbb] [bbbbbbbb]
...
func cmp_bp_63_ne(buf []byte, val uint64, n int, bits *Bitset) *Bitset {
	// 63 bit packed
	// [aaaaaaaa] [aaaaaaaa] [aaaaaaaa] [aaaaaaaa]
