...
//go:noescape
func analyze_i64_neon(vals []int64, ret *Context[int64])

// //go:noescape
// func analyze_i64_neon(vals []int64, ret *Context[int64])

// //go:noescape
// func analyze_i32_neon(vals []int32, ret *Context[int32])

// //go:noescape
// func analyze_i16_neon(vals []int16, ret *Context[int16])

// //go:noescape
// func analyze_i8_neon(vals []int8, ret *Context[int8])

// //go:noescape
// func analyze_u64_neon(vals []uint64, ret *Context[uint64])

// //go:noescape
// func analyze_u32_neon(vals []uint32, ret *Context[uint32])

// //go:noescape
// func analyze_u16_neon(vals []uint16, ret *Context[uint16])

// //go:noescape
// func analyze_u8_neon(vals []uint8, ret *Context[uint8])
