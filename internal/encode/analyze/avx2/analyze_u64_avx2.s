...
// Function declaration: analyze_u64_avx2(vals *uint64, ctx *U64Context, len size_t)
TEXT ·analyze_u64_avx2(SB), NOSPLIT, $0-24
...
run_done:
    ...
    JZ delta_done
    MOVQ R12, R15
    SUBQ R13, R15          // R15 = vals[i] - vals[i-1] (signed 32-bit)
    XORB R11B, R11B
