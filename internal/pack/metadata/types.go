...
var (
	szMetadataIndex = int(reflect.TypeOf(MetadataIndex{}).Size())
	szPackMetadata  = int(reflect.TypeOf(PackMetadata{}).Size())
	szBlockMetadata = int(reflect.TypeOf(BlockMetadata{}).Size())
