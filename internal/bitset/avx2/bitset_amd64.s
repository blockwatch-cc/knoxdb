...
TEXT ·bit_reverse(SB), NOSPLIT, $0-48
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
    MOVQ    reverseLut256_base+24(FP), BP
    MOVQ    SI, DI
...
//
TEXT ·bit_next_one(SB), NOSPLIT, $0-40
	MOVQ		src_base+0(FP), SI
...
//
TEXT ·bit_next_zero(SB), NOSPLIT, $0-40
	MOVQ		src_base+0(FP), SI
	MOVQ		src_len+8(FP), CX
	MOVQ		index+24(FP), BX
	SUBQ		BX, CX
