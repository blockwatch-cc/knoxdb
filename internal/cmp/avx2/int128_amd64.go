...
func MatchInt128Equal(src num.Int128Stride, val num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128Equal(src.Tail(len_head), val, bits[tail:], mask[tail:])
	return res
}
...
func MatchInt128NotEqual(src num.Int128Stride, val num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128NotEqual(src.Tail(len_head), val, bits[tail:], mask[tail:])
	return res
}
...
func MatchInt128Less(src num.Int128Stride, val num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128Less(src.Tail(len_head), val, bits[tail:], mask[tail:])
	return res
}
...
func MatchInt128LessEqual(src num.Int128Stride, val num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128LessEqual(src.Tail(len_head), val, bits[tail:], mask[tail:])
	return res
}
...
func MatchInt128Greater(src num.Int128Stride, val num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128Greater(src.Tail(len_head), val, bits[tail:], mask[tail:])
	return res
}
...
func MatchInt128GreaterEqual(src num.Int128Stride, val num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128GreaterEqual(src.Tail(len_head), val, bits[tail:], mask[tail:])
	return res
}
...
func MatchInt128Between(src num.Int128Stride, a, b num.Int128, bits, mask []byte) int64 {
	...
	res += generic.MatchInt128Between(src.Tail(len_head), a, b, bits[tail:], mask[tail:])
	return res
}
