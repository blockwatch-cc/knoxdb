...
//   Y1-Y8 = vector data
TEXT ·cmp_f32_eq_x2(SB), NOSPLIT, $0-64
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_f32_ne_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_f32_lt_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_f32_le_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_f32_gt_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_f32_ge_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
TEXT ·cmp_f32_bw_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
