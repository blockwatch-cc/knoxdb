...
//   Y1-Y8 = vector data
TEXT ·cmp_i16_eq_x2(SB), NOSPLIT, $0-64
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_i16_ne_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_i16_lt_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_i16_le_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_i16_gt_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·cmp_i16_ge_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
TEXT ·cmp_i16_bw_x2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
