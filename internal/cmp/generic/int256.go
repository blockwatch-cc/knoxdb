...
func MatchInt256Equal(src num.Int256Stride, val num.Int256, res, mask []byte) int64 {
	var cnt int64
	n := src.Len() / 8
	var idx int
	if mask != nil {
...
func MatchInt256NotEqual(src num.Int256Stride, val num.Int256, res, mask []byte) int64 {
	var cnt int64
	n := src.Len() / 8
	var idx int
	if mask != nil {
