...
// Go exports
var (
	Int32Equal        = cmp_i32_eq_x5
	Int32NotEqual     = cmp_i32_ne_x5
	Int32Less         = cmp_i32_lt_x5
	Int32LessEqual    = cmp_i32_le_x5
	Int32Greater      = cmp_i32_gt_x5
	Int32GreaterEqual = cmp_i32_ge_x5
	Int32Between      = cmp_i32_bw_x5
)
