...
// Go exports
var (
	Uint16Equal        = cmp_u16_eq_x5
	Uint16NotEqual     = cmp_u16_ne_x5
	Uint16Less         = cmp_u16_lt_x5
	Uint16LessEqual    = cmp_u16_le_x5
	Uint16Greater      = cmp_u16_gt_x5
	Uint16GreaterEqual = cmp_u16_ge_x5
	Uint16Between      = cmp_u16_bw_x5
)
