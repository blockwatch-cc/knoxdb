...
func cmp_bytes_eq(src [][]byte, val []byte, res, mask []byte) int64 {
	var cnt int64
	n := len(src) / 8
	var idx int
	if mask != nil {
...
func cmp_bytes_ne(src [][]byte, val []byte, res, mask []byte) int64 {
	var cnt int64
	n := len(src) / 8
	var idx int
	if mask != nil {
...
func cmp_bytes_lt(src [][]byte, val []byte, res, mask []byte) int64 {
	var cnt int64
	n := len(src) / 8
	var idx int
	if mask != nil {
...
func cmp_bytes_le(src [][]byte, val []byte, res, mask []byte) int64 {
	var cnt int64
	n := len(src) / 8
	var idx int
	if mask != nil {
...
func cmp_bytes_gt(src [][]byte, val []byte, res, mask []byte) int64 {
	var cnt int64
	n := len(src) / 8
	var idx int
	if mask != nil {
...
func cmp_bytes_ge(src [][]byte, val []byte, res, mask []byte) int64 {
	var cnt int64
	n := len(src) / 8
	var idx int
	if mask != nil {
...
func cmp_bytes_bw(src [][]byte, a, b, res, mask []byte) int64 {
	// shortcut for equal range
	if bytes.Equal(a, b) {
		return cmp_bytes_eq(src, a, res, mask)
	}
