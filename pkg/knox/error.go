...
var (
	...
	ErrNoValues       = errors.New("empty value list")
...
func (t *errorTable) Schema() *schema.Schema     { return nil }
func (t *errorTable) Engine() engine.TableEngine { return nil }
func (t *errorTable) Insert(_ context.Context, _ *schema.Batch) (uint64, int, error) {
	return 0, 0, t.err
}
func (t *errorTable) Update(_ context.Context, _ *schema.Batch) (int, error)       { return 0, t.err }
