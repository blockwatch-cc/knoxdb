...
func NewDecimal32(val int32, scale uint8) Decimal32 {
...
func (d Decimal32) Scale() uint8 {
	return d.scale
}

func (d Decimal32) Precision() uint8 {
	return uint8(digits64(int64(d.val)))
}
...
func (d Decimal32) Quantize(scale uint8) Decimal32 {
	if scale == d.scale {
		return d
	}
...
func (d *Decimal32) SetScale(scale uint8) {
	d.scale = scale
}

func (d *Decimal32) SetInt64(value int64, scale uint8) error {
	if scale > MaxDecimal32Precision {
...
func (d *Decimal32) SetFloat64(value float64, scale uint8) error {
	if scale > MaxDecimal32Precision {
		return ErrScaleOverflow
	}
...
func (d Decimal32) String() string {
	...
	default:
		...
		b.Grow(int(MaxDecimal32Precision + 2))
		if d.val>>31 != 0 {
			b.WriteRune('-')
		}
...
func CompareDecimal32(a, b Decimal32) int {
	return a.Cmp(b)
}
