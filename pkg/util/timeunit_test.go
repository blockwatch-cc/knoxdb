...
var unitTestCases = []unitTestCase{
	{"m", TimeUnit{1, UnitMinute}, time.Minute, 0},
	{"h", TimeUnit{1, UnitHour}, time.Hour, 0},
	{"d", TimeUnit{1, UnitDay}, 24 * time.Hour, 0},
	{"w", TimeUnit{1, UnitWeek}, 7 * 24 * time.Hour, 0},
	{"M", TimeUnit{1, UnitMonth}, 730 * time.Hour, time.Hour},
	{"q", TimeUnit{1, UnitQuarter}, 2190 * time.Hour, time.Hour},
	{"y", TimeUnit{1, UnitYear}, 365 * 24 * time.Hour, 0},
	{"2m", TimeUnit{2, UnitMinute}, 2 * time.Minute, 0},
	{"2h", TimeUnit{2, UnitHour}, 2 * time.Hour, 0},
	{"2d", TimeUnit{2, UnitDay}, 2 * 24 * time.Hour, 0},
	{"2w", TimeUnit{2, UnitWeek}, 2 * 7 * 24 * time.Hour, 0},
	{"2M", TimeUnit{2, UnitMonth}, 2 * 730 * time.Hour, time.Hour},
	{"2q", TimeUnit{2, UnitQuarter}, 2 * 2190 * time.Hour, time.Hour},
	{"2y", TimeUnit{2, UnitYear}, 2 * 365 * 24 * time.Hour, 0},
}
