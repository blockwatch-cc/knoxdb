...
TEXT ·initAVX2Jmp(SB), NOSPLIT, $0-68
        LEAQ            ·unpack240AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>(SB)
        LEAQ            ·unpack120AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+8(SB)
        LEAQ            ·unpack60AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+16(SB)
        LEAQ            ·unpack30AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+24(SB)
        LEAQ            ·unpack20AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+32(SB)
        LEAQ            ·unpack15AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+40(SB)
        LEAQ            ·unpack12AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+48(SB)
        LEAQ            ·unpack10AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+56(SB)
        LEAQ            ·unpack8AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+64(SB)
        LEAQ            ·unpack7AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+72(SB)
        LEAQ            ·unpack6AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+80(SB)
        LEAQ            ·unpack5AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+88(SB)
        LEAQ            ·unpack4AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+96(SB)
        LEAQ            ·unpack3AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+104(SB)
        LEAQ            ·unpack2AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+112(SB)
        LEAQ            ·unpack1AVX2Jmp(SB), DX
        MOVQ            DX, funcTableJmp<>+120(SB)
...
TEXT ·unpack1AVX2Jmp(SB), NOSPLIT, $0-68
        MOVQ            mask1, R8
