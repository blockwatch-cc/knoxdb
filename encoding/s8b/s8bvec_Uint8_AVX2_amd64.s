...
// func decodeAllUint8AVX2Core(dst []uint16, src []byte) (value int)
TEXT ·decodeAllUint8AVX2Core(SB), NOSPLIT, $0-56
        MOVQ            dst_base(FP), DI
...
TEXT ·decodeAllUint8AVX2Exit(SB), NOSPLIT, $0-0
        VZEROUPPER
        SUBQ            R15, DI
        MOVQ            DI, value+48(FP)
        RET
