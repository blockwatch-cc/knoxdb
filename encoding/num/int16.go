...
func MatchInt16Equal(src []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
	bits.ResetCount(int(matchInt16Equal(src, val, bits.Bytes())))
	return bits
}

func MatchInt16NotEqual(src []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
	bits.ResetCount(int(matchInt16NotEqual(src, val, bits.Bytes())))
	return bits
}

func MatchInt16LessThan(src []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
	bits.ResetCount(int(matchInt16LessThan(src, val, bits.Bytes())))
	return bits
}

func MatchInt16LessThanEqual(src []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
	bits.ResetCount(int(matchInt16LessThanEqual(src, val, bits.Bytes())))
	return bits
}

func MatchInt16GreaterThan(src []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
	bits.ResetCount(int(matchInt16GreaterThan(src, val, bits.Bytes())))
	return bits
}

func MatchInt16GreaterThanEqual(src []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
	bits.ResetCount(int(matchInt16GreaterThanEqual(src, val, bits.Bytes())))
	return bits
}

func MatchInt16Between(src []int16, a, b int16, bits, mask *vec.Bitset) *vec.Bitset {
	bits = bits.Grow(len(src))
...
var Int16 = struct {
	...
	MatchEqual    func([]int16, int16, *vec.Bitset, *vec.Bitset) *vec.Bitset
}{
	...
	MatchEqual: func(s []int16, val int16, bits, mask *vec.Bitset) *vec.Bitset {
