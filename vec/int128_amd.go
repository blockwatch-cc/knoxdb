...
func matchInt128Equal(src []Int128, val Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
...
func matchInt128NotEqual(src []Int128, val Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
...
func matchInt128LessThan(src []Int128, val Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
...
func matchInt128LessThanEqual(src []Int128, val Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
...
func matchInt128GreaterThan(src []Int128, val Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
...
func matchInt128GreaterThanEqual(src []Int128, val Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
...
func matchInt128Between(src []Int128, a, b Int128, bits []byte) int64 {
	switch {
	// case useAVX512_F:
