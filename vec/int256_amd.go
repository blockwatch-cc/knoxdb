...
func matchInt256Equal(src []Int256, val Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256EqualGeneric(src, val, bits)
	}
}

func matchInt256NotEqual(src []Int256, val Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256NotEqualGeneric(src, val, bits)
	}
}

func matchInt256LessThan(src []Int256, val Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256LessThanGeneric(src, val, bits)
	}
}

func matchInt256LessThanEqual(src []Int256, val Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256LessThanEqualGeneric(src, val, bits)
	}
}

func matchInt256GreaterThan(src []Int256, val Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256GreaterThanGeneric(src, val, bits)
	}
}

func matchInt256GreaterThanEqual(src []Int256, val Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256GreaterThanEqualGeneric(src, val, bits)
	}
}

func matchInt256Between(src []Int256, a, b Int256, bits []byte) int64 {
	switch {
	// case useAVX512_F:
	...
	default:
		return matchInt256BetweenGeneric(src, a, b, bits)
	}
}
