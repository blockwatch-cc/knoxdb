...
//   Y1-Y8 = vector data
TEXT ·matchInt16EqualAVX2(SB), NOSPLIT, $0-58
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16NotEqualAVX2(SB), NOSPLIT, $0-58
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16LessThanAVX2(SB), NOSPLIT, $0-58
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
loop_big:
	VPCMPGTW		0(SI), Y0, Y1 
	VPCMPGTW		32(SI), Y0, Y2
	VPCMPGTW		64(SI), Y0, Y3
	VPCMPGTW		96(SI), Y0, Y4
	...
	VPCMPGTW		128(SI), Y0, Y5 
	VPCMPGTW		160(SI), Y0, Y6
	VPCMPGTW		192(SI), Y0, Y7
	VPCMPGTW		224(SI), Y0, Y8
	...
	VPCMPGTW		256(SI), Y0, Y1 
	VPCMPGTW		288(SI), Y0, Y2
	VPCMPGTW		320(SI), Y0, Y3
	VPCMPGTW		352(SI), Y0, Y4
	...
	VPCMPGTW		384(SI), Y0, Y5 
	VPCMPGTW		416(SI), Y0, Y6
	VPCMPGTW		448(SI), Y0, Y7
	VPCMPGTW		480(SI), Y0, Y8
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16LessThanEqualAVX2(SB), NOSPLIT, $0-58
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16GreaterThanAVX2(SB), NOSPLIT, $0-58
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16GreaterThanEqualAVX2(SB), NOSPLIT, $0-58
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
TEXT ·matchInt16BetweenAVX2(SB), NOSPLIT, $0-60
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
