...
//   Y1-Y8 = vector data
TEXT ·matchInt16EqualAVX2(SB), NOSPLIT, $0-64
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16NotEqualAVX2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16LessThanAVX2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16LessThanEqualAVX2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16GreaterThanAVX2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
//   Y10 = shuffle control mask
//   Y1-Y8 = vector data
TEXT ·matchInt16GreaterThanEqualAVX2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
...
TEXT ·matchInt16BetweenAVX2(SB), NOSPLIT, $0-64
	MOVQ	src_base+0(FP), SI
	MOVQ	src_len+8(FP), BX
	MOVQ	bits_base+32(FP), DI
	XORQ	R9, R9
