...
type TypedBucket struct {
	...
	read     func(pack.Row) (Aggregatable, error)
}
...
func (b *TypedBucket) readBytes(r pack.Row) (Aggregatable, error) {
...
func (b *TypedBucket) readInt128(r pack.Row) (Aggregatable, error) {
...
func (b *TypedBucket) readInt256(r pack.Row) (Aggregatable, error) {
